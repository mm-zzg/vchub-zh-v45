...
3. 点击下一步，进入详细配置界面。
    ...
    “发送至”默认选择 **钉钉机器人**，如果想发给个人，请勾选 **钉钉账号**，两者允许同时选择。
...
3. 点击“添加机器人”(说明：仅群主和群管理员，可以添加机器人)
...
在钉钉群内，点击右上角的 **群设置按钮**，在群设置弹窗中，点击某个群机器人，即可查看该机器人的Webhook地址和密钥信息。
...
10. 开启 **机器⼈配置**，配置完成点击页面底部的”发布“按钮进行发布
