...
用户可在“资产树”编辑器内，点击更多按钮，可对“模型”和“实例”进行批量操作。
...
选中”模型“选项卡，点击批量操作按钮，对模型进行批量操作。支持导出、导入，批量新增和批量更新。
...
请参考[批量新增](batch-add.md) 

#### 批量更新

对变量的详细设置进行更新。

请参考[批量更新](batch-update.md) 

#### 导出、导入

用于对模型和实例进行备份、将实例复制到其他资产树中。

请参考[导入、导出](export-and-import.md)